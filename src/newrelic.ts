...
exports.config = {
     ...
     */
    app_name: [process.env.NEW_RELIC_APP_NAME || 'NestJS Application'],
    /**
     * Your New Relic license key.
     */
    license_key:
        process.env.NEW_RELIC_LICENSE_KEY ||
        'replace_w_your_newrelic_license_FFFFNRAL',
    /**
    ...
    application_logging: {
        ...
        metrics: {
            enabled:
                process.env.NEW_RELIC_APPLICATION_LOGGING_METRICS_ENABLED ===
                'true',
        },
        forwarding: {
            enabled:
